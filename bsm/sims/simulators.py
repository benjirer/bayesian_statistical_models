...
from bsm.sims.dynamics_models import Pendulum, PendulumParams, RaceCar, CarParams, SergioParams, SergioDynamics
from bsm.sims.util import encode_angles, decode_angles
...
class RaceCarSim(FunctionSimulator):
    ...
    def _set_default_params(self):
        from bsm.sims.car_sim_config import (DEFAULT_PARAMS_BICYCLE_CAR1, DEFAULT_PARAMS_BLEND_CAR1,
